...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { order: @field.order, title: @field.title, type: @field.type, values: @field.values }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { order: @field.order, title: @field.title, type: @field.type, values: @field.values }
    assert_redirected_to field_path(assigns(:field))
  end
